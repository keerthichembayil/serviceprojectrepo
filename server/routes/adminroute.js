...
const {registerAdmin,adminLogin,listProviders,listUsers,getProviderById,approveProvider,listspecificuser,gettotalusers,gettotalproviders,getTotalRequestsPending,getTotalRequestsCompleted,maxRating,userforActive,toggleUserStatus,rejectProvider} = require("../controllers/adminController");
...
router.put("/rejectprovider/:id", protect,authorize("admin") ,rejectProvider);
