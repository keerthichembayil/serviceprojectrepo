...
export const requestService = createAsyncThunk(
  ...
  async ({ providerId,services, additionalNotes,serviceDate }, { rejectWithValue,getState }) => {
    try {
      ...
      const response = await axios.post("/service/request", { providerId, services,additionalNotes,serviceDate }, config);
